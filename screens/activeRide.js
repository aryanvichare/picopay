...
export default function ActiveRide() {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={{color:"#FCC281", fontWeight:'bold', fontSize:16, textAlign:'left', marginTop:'10%', marginHorizontal:'10%', marginBottom:'2.5%'}}>Active Transportation</Text>
            <Image source={require('../assets/bus.png')} style={{alignSelf:'center'}}></Image>
            <Text style={{color:"#FCC281", fontWeight:'bold', fontSize:16, textAlign:'center', marginTop:'10%', marginHorizontal:'10%', marginBottom:'2.5%'}}>Ride Time</Text>
            <View style={{backgroundColor:"#494E76",paddingHorizontal:'2.5%', borderRadius:10, paddingVertical:'1%', width:'65%', justifyContent:'space-evenly', alignSelf:'center'}}>
            ...
            <Text style={{color:"#FCC281", fontWeight:'bold', fontSize:16, textAlign:'left', marginHorizontal:'10%', marginBottom:'2.5%'}}>Transportation: <Text style={{color:"#FFF"}}>Bus</Text></Text>
            <Text style={{color:"#FCC281", fontWeight:'bold', fontSize:16, textAlign:'left', marginHorizontal:'10%', marginBottom:'2.5%'}}>Total Price: <Text style={{color:"#FFF"}}>20 MIA</Text></Text>

            <View style={{backgroundColor:"#FCC281", width:'80%', alignSelf:'center', borderRadius:10, height:'5%', marginTop:'.5%', padding:10}}>
            <TouchableOpacity><Text style={{color:"#353958", fontWeight:'bold', textAlign:'center'}}>END RIDE</Text></TouchableOpacity>
            </View>
            


            <View style={{backgroundColor:"#FFF", height:'10%', width:'100%', marginTop:'5%', flexDirection:'row', justifyContent:'space-around'}}>
